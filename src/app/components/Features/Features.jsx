...
export default function Features() {
    return(
        <section className={styles.outerContainer} id='features'>
            <h1 className={styles.title} >Features</h1>
            <div className={styles.featuresContainer}>
                <div className={`${styles.singleFeatureContainer} ${styles.singleFeatureContainerReversed}`}>
                    <div className={styles.img} >
                        <img src="/med-reminders.png" alt="Notification screen" />
                    </div>
                ...
                <div className={styles.singleFeatureContainer}>
                    ...
                    <div className={styles.img} >
                        <img src="/med-logging.png" alt="Loggin med card" />
                    </div>
                </div>
                <div className={`${styles.singleFeatureContainer} ${styles.singleFeatureContainerReversed}`}>
                    <div className={styles.img} id={styles.scanningImg}>
                        <img src="/scanning.png" alt="Med scanning screen" />
                    </div>
                    <div className={styles.description}>
                ...
                <div className={styles.singleFeatureContainer}>
                    ...
                    <div className={styles.img}>
                        <img src="/med-library.png" alt="Med library screen" />
                    </div>
                </div>
            </div>
        </section>
